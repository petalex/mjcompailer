...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(NoPrintNumConsts NoPrintNumConsts) { visit(); }
    public void visit(PrintNumConsts PrintNumConsts) { visit(); }
    ...
    public void visit(FirstFormalParameter FirstFormalParameter) { visit(); }
    ...
    public void visit(NoImplementsInterfaces NoImplementsInterfaces) { visit(); }
    ...
    public void visit(FirstVarIdentifier FirstVarIdentifier) { visit(); }
